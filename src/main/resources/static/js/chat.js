...
function increaseMaleAge() {
    $.ajax({
        type: 'get',
        url: '/updateCheckoutTime?gender=male&action=increase',
        cache: false,
        success: function (data) {
            console.log(data);
        },
...
function decreaseMaleAge() {
    $.ajax({
        type: 'get',
        url: '/updateCheckoutTime?gender=male&action=rest',
        cache: false,
        success: function (data) {
            console.log(data);
        },
...
function increaseFemaleAge() {
    $.ajax({
        type: 'get',
        url: '/updateCheckoutTime?gender=female&action=increase',
        cache: false,
        success: function (data) {
            console.log(data);
        },
...
function decreaseFemaleAge() {
    $.ajax({
        type: 'get',
        url: '/updateCheckoutTime?gender=female&action=rest',
        cache: false,
        success: function (data) {
            console.log(data);
        },
